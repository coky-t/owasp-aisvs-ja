...
本標準には、他の章への参照、ASVS 要件への参照、管理目標やセクションのスコープに含まれるまたは除外される具体的な懸念事項に関するその他の情報を含む、スコープに関する注意を含みます。
...
AISVS レベルは ASVS レベルと整合するように目指しており、それぞれのレベルについての関連ガイダンスに従う必要があります。
