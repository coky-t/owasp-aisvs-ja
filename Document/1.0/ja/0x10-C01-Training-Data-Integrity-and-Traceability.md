...
| # | 説明 | レベル | ロール |
|:--------:|---------------------------------------------------------------------------------------------------------------------|:---:|:---:|
| **1.3.1** | **検証:** ラベリングインタフェースとプラットフォームはアクセス制御を実施し、すべてのラベリングアクティビティの監査ログを維持している。 | 1 | D/V |
| **1.3.2** | **検証:** 暗号化ハッシュまたはデジタル署名はラベリングアーティファクトとアノテーションデータに適用され、完全性と真正性を確保している。 | 2 | D/V |
