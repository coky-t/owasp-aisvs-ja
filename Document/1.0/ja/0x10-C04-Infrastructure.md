...
信頼できない AI モデルは安全なサンドボックスと、高信頼実行環境 (TEE) と機密コンピューティングテクノロジを使用して保護される機密性の高い AI ワークロードで分離されている必要があります。
...
GPU、TPU、特殊な AI アクセラレータなどの AI 固有のハードウェアコンポーネントが保護されている必要があります。
...
エッジコンピューティング、連合学習、マルチサイトアーキテクチャなどの分散 AI デプロイメントが保護されている必要があります。
