...
このプロジェクトは [Jim Manico](https://linkedin.com/in/jmanico) によって設立されました。現在のプロジェクトリーダーは [Jim Manico](https://linkedin.com/in/jmanico), [Otto Sulin](https://github.com/ottosulin), [Rico Komenda](https://github.com/RicoKomenda), [Russ Memisyazici](https://linkedin.com/in/vtxmm), [Raza Sharif](https://github.com/razasharif) です。
